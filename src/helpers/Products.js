...
let p6 = {id : "5", nombre: 'DayZ', precio : 40, stock : 36, brand : 'Novedad', description : 'Mecánica de supervivencia compleja y auténtica.', url : 'https://cdn.cdkeys.com/265x265/media/catalog/product/h/e/header_10_18_.jpg'}
let p7 = {id : "5", nombre: 'Gears of War', precio : 60, stock : 8, brand : 'Novedad', description : 'Experimenta el juego que lanzó una de las sagas más célebres del entretenimiento', url : 'https://cdn.cdkeys.com/265x265/media/catalog/product/h/e/hero_10_.jpg'}
let p8 = {id : "5", nombre: 'Hollow Knight', precio : 18, stock : 24, brand : 'Novedad', description : 'Prepárate para forjar tu propio camino en un mundo épico al estilo de Metroidvania!', url : 'https://cdn.cdkeys.com/265x265/media/catalog/product/h/k/hk.jpg'}
